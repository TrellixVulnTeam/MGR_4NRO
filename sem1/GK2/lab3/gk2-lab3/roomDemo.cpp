...
void RoomDemo::DrawWalls()
{
	...
	XMStoreFloat4x4(&texMtx, XMMatrixTranslation(2.0f, 2.0f, 0.0f) * XMMatrixScaling(0.25f, 0.25f, 0.0f));
	...
	SetTextures({ m_wallTexture.get(),m_posterTexture.get() }, m_samplerWrap_back);
	...
	XMStoreFloat4x4(&texMtx, XMMatrixTranslation(2.0f, 2.0f, 0.0f) * XMMatrixScaling(0.25f, 4.0f, 0.0f));
	UpdateBuffer(m_cbTex1Mtx, texMtx);
