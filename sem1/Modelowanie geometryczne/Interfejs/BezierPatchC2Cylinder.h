...
class BezierPatchC2Cylinder : public SomePatch
{
public:
	BezierPatchC2Cylinder();
	BezierPatchC2Cylinder(int _n, int _m, float _r, float _length) :BezierPatchC2Cylinder() { n = _n; m = _m; r = _r; length = _length; }
