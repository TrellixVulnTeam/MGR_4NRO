...
void Figure::ScaleX(float change)
{
	scale[0][0] *= change;
	RecalcModel();
}

void Figure::ScaleY(float change)
{
	scale[1][1] *= change;
	RecalcModel();
}

void Figure::ScaleZ(float change)
{
	scale[2][2] *= change;
	RecalcModel();
}
...
void Figure::ScaleAroundX(glm::vec3 point, float change)
{
	glm::mat4 scale = glm::mat4(change);
	scale[1][1] = 1.0f;
	scale[2][2] = 1.0f;
...
void Figure::ScaleAroundY(glm::vec3 point, float change)
{
	glm::mat4 scale = glm::mat4(change);
	scale[0][0] = 1.0f;
	scale[2][2] = 1.0f;
...
void Figure::ScaleAroundZ(glm::vec3 point, float change)
{
	glm::mat4 scale = glm::mat4(change);
	scale[1][1] = 1.0f;
	scale[0][0] = 1.0f;
