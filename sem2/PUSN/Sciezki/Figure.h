...
public:
	...
	void ScaleX(float change);
	void ScaleY(float change);
	void ScaleZ(float change);
	...
	void ScaleAroundX(glm::vec3 point, float change);
	void ScaleAroundY(glm::vec3 point, float change);
	void ScaleAroundZ(glm::vec3 point, float change);
