...
void MiddlePoint::Initialize(std::shared_ptr<Program> _program)
{
	Figure::Initialize(_program);
}

bool MiddlePoint::GetGuiInternal(std::shared_ptr<Figure> par)
{
	bool b = false;
...
void MiddlePoint::Add(std::shared_ptr<Figure> figure)
{
