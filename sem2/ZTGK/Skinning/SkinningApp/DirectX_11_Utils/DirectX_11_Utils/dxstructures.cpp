...
DepthStencilDescription DepthStencilDescription::DepthStencilEnable()
{
	DepthStencilDescription depthEnableStencilDescription;
	ZeroMemory(&depthEnableStencilDescription, sizeof(depthEnableStencilDescription));

	depthEnableStencilDescription.DepthEnable = true;
	depthEnableStencilDescription.DepthWriteMask = D3D11_DEPTH_WRITE_MASK_ALL;
	depthEnableStencilDescription.DepthFunc = D3D11_COMPARISON_LESS;
	depthEnableStencilDescription.StencilEnable = true;
	depthEnableStencilDescription.StencilReadMask = 0xFF;
	depthEnableStencilDescription.StencilWriteMask = 0xFF;
	depthEnableStencilDescription.FrontFace.StencilFailOp = D3D11_STENCIL_OP_KEEP;
	depthEnableStencilDescription.FrontFace.StencilDepthFailOp = D3D11_STENCIL_OP_INCR;
	depthEnableStencilDescription.FrontFace.StencilPassOp = D3D11_STENCIL_OP_KEEP;
	depthEnableStencilDescription.FrontFace.StencilFunc = D3D11_COMPARISON_ALWAYS;
	depthEnableStencilDescription.BackFace.StencilFailOp = D3D11_STENCIL_OP_KEEP;
	depthEnableStencilDescription.BackFace.StencilDepthFailOp = D3D11_STENCIL_OP_DECR;
	depthEnableStencilDescription.BackFace.StencilPassOp = D3D11_STENCIL_OP_KEEP;
	depthEnableStencilDescription.BackFace.StencilFunc = D3D11_COMPARISON_ALWAYS;

	return depthEnableStencilDescription;
}

DepthStencilDescription DepthStencilDescription::DepthStencilDisable()
{
	DepthStencilDescription depthDisableStencilDescription;
	ZeroMemory(&depthDisableStencilDescription, sizeof(depthDisableStencilDescription));

	depthDisableStencilDescription.DepthEnable = false;
	depthDisableStencilDescription.DepthWriteMask = D3D11_DEPTH_WRITE_MASK_ALL;
	depthDisableStencilDescription.DepthFunc = D3D11_COMPARISON_LESS;
	depthDisableStencilDescription.StencilEnable = true;
	depthDisableStencilDescription.StencilReadMask = 0xFF;
	depthDisableStencilDescription.StencilWriteMask = 0xFF;
	depthDisableStencilDescription.FrontFace.StencilFailOp = D3D11_STENCIL_OP_KEEP;
	depthDisableStencilDescription.FrontFace.StencilDepthFailOp = D3D11_STENCIL_OP_INCR;
	depthDisableStencilDescription.FrontFace.StencilPassOp = D3D11_STENCIL_OP_KEEP;
	depthDisableStencilDescription.FrontFace.StencilFunc = D3D11_COMPARISON_ALWAYS;
	depthDisableStencilDescription.BackFace.StencilFailOp = D3D11_STENCIL_OP_KEEP;
	depthDisableStencilDescription.BackFace.StencilDepthFailOp = D3D11_STENCIL_OP_DECR;
	depthDisableStencilDescription.BackFace.StencilPassOp = D3D11_STENCIL_OP_KEEP;
	depthDisableStencilDescription.BackFace.StencilFunc = D3D11_COMPARISON_ALWAYS;

	return depthDisableStencilDescription;
}
