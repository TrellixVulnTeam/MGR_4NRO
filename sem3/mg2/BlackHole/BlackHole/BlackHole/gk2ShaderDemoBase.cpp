...
GK2ShaderDemoBase::GK2ShaderDemoBase(HINSTANCE hInst)
	: DxApplication(hInst, 1366,768, L"Black Hole"), m_loader(m_device), m_layouts(m_device), m_camera(0.01f, 50.0f, 5),
...
int GK2ShaderDemoBase::MainLoop()
{
	...
	auto pos = m_camera.getCameraPosition();
	auto pos2 = m_camera.getPointPosition(XMFLOAT3 (-0.2f,0.0f,0.0f),m_frustrum);
	auto pos3 = m_camera.getPointPosition(XMFLOAT3 (-0.2f,0.0f,1.0f),m_frustrum);
	auto dir = XMFLOAT3(pos3.x - pos2.x, pos3.y - pos2.y, pos3.z - pos2.z);
